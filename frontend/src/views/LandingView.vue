...
const faqItems = ref([
  ...
  { q: 'Нужен ли VIN для анализа?', a: 'VIN необязателен. Базовый анализ работает по марке, модели, году и пробегу. Если VIN указан — сервис дополнительно учитывает доступные по нему сведения в рамках анализа.', open: false },
...
<template>
  ...
  <footer class="footer">
    <div class="wrap">
      ...
      <div class="copy">© 2026 ПОДКАПОТ · Информационно-консультационный сервис: анализ объявления и помощь в осмотре авто перед покупкой.</div>
      <div class="copy" style="margin-top:6px">Самозанятый Долгушев Д. М. · ИНН 320207587587 · <a href="mailto:dolgushevdaniel@yandex.ru" style="color:inherit">dolgushevdaniel@yandex.ru</a></div>
    </div>
  </footer>
</template>
